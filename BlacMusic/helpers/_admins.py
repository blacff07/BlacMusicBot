...
def admin_check(func):
    ...
    async def wrapper(_, update: types.Message | types.CallbackQuery, *args, **kwargs):
        ...
        # Sudo users (bot owner) can bypass the admin check entirely -
        # check this before touching the database, since sudo commands
        # shouldn't pay for an admin-list lookup they don't need.
