...
async def broadcast_message(_, message: types.Message) -> None:
    ...
    success_groups, success_users, pinned_count, failed_chats = await _send_broadcast(
    ...
    await _send_broadcast_completion(
        message, sent, success_groups, success_users, pinned_count, failed_chats, media_message
    )
...
async def _send_broadcast(
    ...
    Returns:
        Tuple of (successful groups count, successful users count, pinned count, failed chats log)
    """
    global broadcasting
    ...
    return success_groups, success_users, pinned_count, failed_log
...
async def _send_broadcast_completion(
    ...
    Args:
        ...
        pinned_count: Number of messages successfully pinned.
