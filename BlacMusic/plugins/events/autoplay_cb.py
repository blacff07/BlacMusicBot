...
async def autoplay_pick_cb(_, cq: types.CallbackQuery) -> None:
    ...
    try:
        ...
        # Track title comes from YouTube metadata - untrusted - escape before
        # embedding in HTML-parsed messages below.
            ...
            try:
                await app.send_message(
                    ...
                    text=(
                        ...
                        f"▶ <a href='{track.url}'>{safe_title}</a>\n"
                        f"⏱ {track.duration}\n"
